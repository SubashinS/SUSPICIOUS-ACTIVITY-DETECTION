...
cap = cv2.VideoCapture('C:\\Users\\tirza\\Desktop\\SUSPICIOUS ACTIVITY DETECTION\\yolo11_suspicious_activity-main\\susp1.mp4')
...
video_writer = cv2.VideoWriter("C:\\Users\\tirza\\Desktop\\SUSPICIOUS ACTIVITY DETECTION\\yolo11_suspicious_activity-main\\suspicious.mp4", cv2.VideoWriter_fourcc(*"mp4v"), fps, frame_size)
