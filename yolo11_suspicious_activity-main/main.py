...
video_path = r"C:\Users\tirza\Desktop\SUSPICIOUS ACTIVITY DETECTION\yolo11_suspicious_activity-main\susp1.mp4"

def detect_shoplifting(video_path):
    # Load YOLOv8 model (replace with the actual path to your YOLOv8 model)
    model_yolo = YOLO(r'C:\Users\tirza\Desktop\SUSPICIOUS ACTIVITY DETECTION\yolo11s-pose.pt')

    # Load the trained XGBoost model (replace with the actual path to your XGBoost model)
    model = xgb.Booster()
    model.load_model(r'C:\Users\tirza\Desktop\SUSPICIOUS ACTIVITY DETECTION\yolo11_suspicious_activity-main\trained_model.json')
